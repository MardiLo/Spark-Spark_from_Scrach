...
if __name__ == "__main__":
    # Set Spark Config. (run in local by a cpu and name the job as "StumbleUponEvergreenClassificationBySVM")
    # Make a SparkContext object, and Depreciate Spark Warning
    conf = SparkConf().setMaster("local").setAppName("StumbleUponEvergreenClassificationBySVM")
